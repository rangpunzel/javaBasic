...
public class Ingeritance {
	...
	public static void main(String[] args) {
		 ...
		 * - 두개 이상의 클래스는 만드는데 공통된 멤버가 있는 경우 부모클래스로 만든다.
		 * 
		 * << super >>
		 * - 부모 클래스의 인스턴스 주소가 저장된 변수이다.
		 * - 부모 클래스이 멤버와 자식 클래스의 멤버의 이름이 중복될 때 둘을 구분하기 위해 사용한다.
		 * 
		 * << super() >>
		 ...
		 * - 상속받은 메서드보다 좁은 범위의 접근 제어자로 변경할 수 없다.
		 ...
		 * - 부모와 자식이 동일한 메서드가 있는 경우 자식의 메서드를 사용한다.
...
//		t.setHour(1);
//		t.setMinute(61);
//		t.setSecond(5); //유효성 체크때문에 메서드를 통해 나오게 하기 위해서..
